...
<h3><?php _e( 'Select courses', 'learnpress' ); ?></h3>
<?php if ( $courses ): $course_ids = array(); ?>
	<table class="list-export-courses">
		<thead>
		<tr>
			<th><?php _e( 'Course', 'learnpress' ); ?></th>
			<th><?php _e( 'Author/Instructor', 'learnpress' ); ?></th>
		</tr>
		</thead>
		<tbody>
...
<p class="lpie-error-message hide-if-js" id="lpie-no-course-selected">
	<?php _e( 'No course selected', 'learnpress' ); ?>
</p>
<p>
	<button class="button button-primary" id="button-export-next" disabled="disabled"><?php _e( 'Next', 'learnpress' ); ?></button>
