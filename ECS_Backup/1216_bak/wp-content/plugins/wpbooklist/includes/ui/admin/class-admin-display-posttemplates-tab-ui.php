<?php
/**
 * WPBookList PostTemplates Display Options Tab Class
 *
 * @author   Jake Evans
 * @category Admin
...
if ( ! class_exists( 'WPBookList_PostTemplates_Display_Options_Tab', false ) ) :
/**
 * WPBookList_Admin_Menu Class.
 */
class WPBookList_PostTemplates_Display_Options_Tab {

    public function __construct() {
        require_once(CLASS_DIR.'class-admin-ui-template.php');
        require_once(CLASS_DIR.'class-posttemplates-display-options-form.php');
        // Instantiate the class
        $this->template = new WPBookList_Admin_UI_Template;
        $this->form = new WPBookList_PostTemplates_Display_Options_Form ;
    ...
    private function output_open_admin_container(){
        $title = __('Post Templates', 'wpbooklist');
...
// Instantiate the class
$am = new WPBookList_PostTemplates_Display_Options_Tab;