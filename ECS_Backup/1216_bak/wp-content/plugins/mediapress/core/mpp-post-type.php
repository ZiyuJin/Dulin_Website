...
class MPP_Post_Type_Helper {
	...
	private function register_post_types() {
		...
		$_labels = array(
			...
			'view_item'          => _x( 'View Gallery', 'admin view gallery label', 'mediapress' ),
			'search_items'       => _x( 'Search Galleries', 'admin search galleries label', 'mediapress' ),
