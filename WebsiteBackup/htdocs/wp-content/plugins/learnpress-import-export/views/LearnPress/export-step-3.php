<div id="exporting" class="hide-if-js">
	...
	<?php _e( 'Exporting...', 'learnpress' ); ?>
</div>
<div id="exported">
	<?php _e( 'Exported', 'learnpress' ); ?>
	...
	<p>
		<button class="button button-primary" id="lpie-button-cancel"><?php _e( 'Export new', 'learnpress' ); ?></button>
		<button class="button" id="lpie-export-again"><?php _e( 'Export again!', 'learnpress' ); ?></button>
	</p>
</div>
