...
<div id="export-step-2-options">
	<ul class="form-options">
		<li>
			<label>
				<?php _e( 'Download file', 'learnpress' ); ?>
			</label>
			<input type="hidden" name="download_export" value="0" />
			<input type="checkbox" name="download_export" value="1" checked="checked" />
			<p class="description">
				<?php _e( 'Download file after exporting is completed', 'learnpress' ); ?>
			</p>
		</li>
		<li>
			<label>
				<?php _e( 'Save exported file', 'learnpress' ); ?>
			</label>
			<input type="hidden" name="save_export" value="0" />
			<input type="checkbox" name="save_export" value="1" />
			<p class="description">
				<?php _e( 'Save exported file on your server so you can download it later', 'learnpress' ); ?>
			</p>
		</li>
	</ul>
	...
	<?php endif; ?>
	<p>
		<input class="regular-text" value="<?php echo $this->get_export_file_name_without_ext(); ?>" type="text" name="learn-press-export-file-name" placeholder="<?php _e( 'Custom name of export file', 'learnpress' ); ?>" />.xml
	</p>
	<p>
		<button class="button button-primary" id="button-export" disabled="disabled"><?php _e( 'Export now', 'learnpress' ); ?></button>
		<button class="button" id="lpie-button-back-step"><?php _e( 'Back', 'learnpress' ); ?></button>
		<button class="button" id="lpie-button-cancel"><?php _e( 'Cancel', 'learnpress' ); ?></button>
	</p>
</div>
