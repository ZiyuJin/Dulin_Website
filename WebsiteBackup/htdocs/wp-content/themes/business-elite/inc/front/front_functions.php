...
class Business_elite_frontend_functions extends WDWT_frontend_functions
{
  ...
  public static function posted_on_single()
  {
    ...
    printf('<span class="date_link"><span class="sep date"></span><span class="screen-reader-text">' . __('Posted on', "business-elite") . '</span><a href="%1$s" title="%2$s" rel="bookmark">' . $time_string . '</a></span><span class="by-author"> <span class="sep author"></span> <span class="author vcard"><a class="url fn n" href="%5$s" title="%6$s" rel="author">%7$s</a></span></span>',
              ...
              while ($wp_query->have_posts()) {
                ...
                <li>
                  ...
                  <div class="top_content">
                    <!-- TITLE -->
                    <a href="<?php the_permalink(); ?>"><h4 class="top_post_title"><?php the_title(); ?></h4></a>
                    <!-- CONTENT -->
                    ...
                    if (isset($top_tabs_category['recent'])) {
                      ...
                      if ($tabs_query->have_posts()) : while ($tabs_query->have_posts()) : $tabs_query->the_post();
                        ...
                        if (has_post_thumbnail()) {
                          $listt .= '<div class="thumbnail-block" ' . $style . '><div class="hide_title"><h4>' . get_the_title() . '</h4></div></div> ';
                        } else {
                          $listt .= '<div class="thumbnail-block" ' . $style_d . '><div class="hide_title"><h4>' . get_the_title() . '</h4></div></div> ';
                        }
      ...
      if ($featured_bg_img != "") { ?>
        <div id="videos-block" class="content-inner-block"
          ...
          <div class="full-width">
            <h2 id="p1"><a href="<?php echo get_permalink($featured->ID); ?>"> <?php echo $featured->post_title; ?> </a>
            </h2>
                ...
                <div class="content-post post_image slide-in-right">
                  ...
                  <div class="home_blog_post">
                    <h4><a href="<?php echo get_permalink() ?>"
                           rel="content-post-<?php echo $id; ?>-title"> <?php the_title(); ?> </a></h4>
                    <div id="single_text">
                      <p
  ...
  public static function content_for_home()
  {
    ...
    <div id="blog_home" class="content-posts">
      ...
      <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
        <div class="blog-post home-post entry hentry">
          <?php
          if ($is_index) {
          ...
          <h2 class="blog-post-title">
            <a class="title_href" href="<?php echo get_permalink() ?>">
              <?php self::the_title_max_charlength(40); /*the_title();*/ ?>
            </a>
          </h2>
          <?php if ($blog_style && $is_index) {
            the_excerpt();
          } elseif ($is_index) {
