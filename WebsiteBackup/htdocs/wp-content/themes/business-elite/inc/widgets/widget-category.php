...
class Business_elite_categ extends WP_Widget
{
  ...
  function widget($args, $instance)
  {
    ...
    while ($wp_query->have_posts()) : $wp_query->the_post(); ?>
      ...
      <div class="cat_widg_cont">
        ...
        <div class="cat_widg">
          <?php if (has_post_thumbnail() || (Business_elite_frontend_functions::post_image_url() && $grab_image)) { ?>
            <a href="<?php the_permalink(); ?>">
  ...
  function form($instance)
  {
    ...
    <p>
      <label
        for="<?php echo $this->get_field_id('post_count'); ?>"><?php _e("Number of Posts:", "business-elite"); ?></label><input
