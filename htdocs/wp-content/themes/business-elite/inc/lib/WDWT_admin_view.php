...
class WDWT_admin_view
{
    ...
    <div class="wdwt_param" id="wdwt_wrap_<?php echo $element['name']; ?>">
      <div class="block margin">
        <div class="optioninput checkbox">
          <span id="<?php echo $element['name']; ?>" class="button"
                style="text-decoration:none;"><?php echo esc_html($element['title']); ?></span>
        </div>
      </div>
      <script>
  ...
  public function checkbox($element, $context = 'option', $opt_val = '', $meta = array())
  {
    ...
    <div class="wdwt_param" id="wdwt_wrap_<?php echo $element['name']; ?>">
      <div class="block margin">
        <div class="optioninput checkbox">
          <input type="checkbox" class="checkbox" name="<?php echo $optionname; ?>"
                 id="<?php echo $element['name'] ?>" <?php checked($opt_val || $opt_val == 'on'); ?> <?php $this->custom_attrs($element); ?>
  ...
  public function color($element, $context = 'option', $opt_val = '', $meta = array())
  {
    ...
    <div class="wdwt_param" id="wdwt_wrap_<?php echo $element['name']; ?>">
      <div class='wdwt_float'>
        <div>
          <input type="text" class='color_input' id="<?php echo $element['name']; ?>" name="<?php echo $optionname; ?>"
                 value="<?php echo esc_attr($opt_val); ?>"
                 data-default-color="<?php echo $element['default']; ?>" <?php $this->custom_attrs($element); ?>
                 style="background-color:<?php echo esc_attr($opt_val); ?>;">
        </div>
      </div>
    </div>
    ...
    <div class="wdwt_param" id="wdwt_wrap_<?php echo $element['name']; ?>">
      <div class="block">
        <div class="optioninput">
          <input type="text" name="<?php echo $optionname; ?>"
                 id="<?php echo $element['name']; ?>" <?php $this->custom_attrs($element); ?>
  ...
  public function number($element, $context = 'option', $opt_val = '', $meta = array())
  {
    ...
    <div class="wdwt_param" id="wdwt_wrap_<?php echo $element['name']; ?>">
      <div class="block">
        <div class="optioninput">
          <input type="number" name="<?php echo $optionname; ?>"
                 id="<?php echo $element['name']; ?>" <?php $this->custom_attrs($element); ?>
                 value="<?php echo esc_attr($opt_val); ?>" min="<?php echo $min; ?>" max="<?php echo $max; ?>"
                 step="<?php echo $step; ?>">
          <?php
          if (isset($element['unit_symbol'])) {
            echo $element['unit_symbol'];
    ...
    <div class="wdwt_param" id="wdwt_wrap_<?php echo $element['name']; ?>">
      <?php foreach ($element['valid_options'] as $key => $option) { ?>
        <label><input type="radio"
                      name="<?php echo $optionname; ?>" <?php checked($key, $opt_val); ?> <?php $this->custom_attrs($element); ?>
                      value="<?php echo esc_attr($key); ?>"/> <?php echo esc_html($option); ?></label>
      <?php } ?>
    </div>
    <?php
  }
    ...
    <div class="wdwt_param" id="wdwt_wrap_<?php echo $element['name']; ?>">
      ...
      foreach ($element['valid_options'] as $option) { ?>
        <div class="sprite_layouts">
          <label>
            <div alt="<?php echo esc_attr($option['title']); ?>"
                 style="width:<?php echo esc_attr($element['img_width']); ?>px; height:<?php echo esc_attr($img_h); ?>px; background:url(<?php echo esc_url(WDWT_IMG_INC . $element['img_src']); ?>) no-repeat 0 -<?php echo (intval($option['index']) - 1) * $img_h; ?>px;"></div>
            <input type="radio"
                   name="<?php echo $optionname; ?>" <?php checked($option['index'], $opt_val); ?> <?php $this->custom_attrs($element); ?>
                   value="<?php echo intval($option['index']); ?>">
          </label>
        </div>
        <?php
      }
    ...
    <div class="wdwt_param" id="wdwt_wrap_<?php echo $element['name']; ?>">
      ...
      foreach ($element['valid_options'] as $option) { ?>
        <div class="sprite_layouts">
          <label>
            <div alt="<?php echo esc_attr($option['title']); ?>"
                 style="width:<?php echo $element['img_width']; ?>px; height:<?php echo $img_h; ?>px; background:url(<?php echo esc_url(WDWT_IMG_INC . $element['img_src']); ?>) no-repeat 0 -<?php echo (intval($option['index']) - 1) * $img_h; ?>px;"></div>
            <input type="radio"
                   name="<?php echo $optionname; ?>" <?php checked($option['index'], $opt_val); ?> <?php $this->custom_attrs($element); ?>
                   value="<?php echo intval($option['index']); ?>">
          </label>
      ...
      <div class="block">
        <div class="optioninput">
          <select name="<?php echo $optionname; ?>"
                  id="<?php echo $element['name'] ?>" <?php echo $multiple ? 'multiple="multiple"' : ''; ?> <?php $this->custom_attrs($element); ?>
                  style="width:<?php echo $width; ?>px; resize:vertical;">
            <?php foreach ($element['valid_options'] as $key => $value) { ?>
              <option
                value="<?php echo esc_attr($key) ?>" <?php selected(true, in_array($key, $opt_val)); ?> <?php echo in_array($key, $disabled) ? 'disabled="disabled"' : ''; ?>>
  ...
  public function select_open($element, $context = 'option', $opt_val = '', $meta = array())
  {
    ...
    <div class="wdwt_param" id="wdwt_wrap_<?php echo $element['name']; ?>">
      <select name="<?php echo $optionname; ?>"
        ...
        <?php foreach ($element['valid_options'] as $key => $value) { ?>
          <option
            value="<?php echo esc_attr($key); ?>" <?php selected(true, in_array($key, $opt_val)); ?>><?php echo esc_html($value); ?></option>
        <?php } ?>
      </select>
    </div>
    <script>
  ...
  public function select_style($element, $context = 'option', $opt_val = '', $meta = array())
  {
    ...
    if ($this->state === 'original') {
      ...
      <script>
        WebFontConfig = {
          google: {
            families: ['Alegreya+SC:400,400italic,700italic,700',
  ...
  public function textarea($element, $context = 'option', $opt_val = '', $meta = array())
  {
    ...
    <div class="wdwt_param" id="wdwt_wrap_<?php echo $element['name']; ?>">
      <div class="block">
        <div class="optioninput">
          <textarea name="<?php echo $optionname; ?>"
                    id="<?php echo $element['name'] ?>" <?php $this->custom_attrs($element); ?>
                    style="width:<?php echo $textarea_w; ?>px; height:<?php echo $textarea_h; ?>px;"><?php echo esc_html(stripslashes($opt_val)); ?></textarea>
        </div>
      </div>
    </div>
    <?php
  ...
  public function text_preview($element, $context = 'option', $opt_val = '', $meta = array())
  {
    ...
    <div class="font_preview_wrap" id="wdwt_wrap_<?php echo $element['name']; ?>">
      <label class="typagrphy_label" for=""
             style="font-size:18px;font-size: 20px;font-family: Segoe UI;"><?php echo __('Preview', "business-elite"); ?></label>
      <div class="font_preview">
        <div class="optioninput-preview" id="<?php echo $element['name']; ?>"
             style="margin-top: 14px; margin-bottom: 23px;"><?php
          $theme = wp_get_theme();
  ...
  public function upload_single($element, $context = '', $opt_val = '')
  {
    ...
    <div class="wdwt_param" id="wdwt_wrap_<?php echo $element['name']; ?>">
      <div class="optioninput" id="upload_images">
        <input type="text" class="upload" id="<?php echo $element["name"] ?>" name="<?php echo $optionname; ?>"
               size="<?php echo $upload_size; ?>" <?php $this->custom_attrs($element); ?>
               value="<?php echo esc_url($opt_val); ?>"/>
        <input class="upload-button button" type="button" id="uploader_<?php echo $element['name']; ?>"
               value="<?php esc_attr_e('Upload Image', "business-elite"); ?>"/>
        <input class="reset-button button" type="button" id="resetdef_<?php echo $element['name']; ?>"
               value="<?php esc_attr_e('Reset', "business-elite"); ?>"/>
        <input type="hidden" class="defaultImgValue" id="default_<?php echo $element["name"] ?>"
  ...
  public function upload_multiple($element, $context = '', $opt_val = '', $meta = array())
  {
    ...
    <div class="wdwt_param" id="wdwt_wrap_<?php echo $element['name']; ?>">
      <div class="wdwt_slide wdwt_slide_<?php echo $element['name']; ?> last_slide"
           id="wdwt_slide_<?php echo $element['name']; ?>_0">
        <!-- Image URL -->
        <div class="slide-from-base_url" style="margin-bottom:3%;">
          <div valign="middle"><h4><?php esc_html_e("Image URL", "business-elite"); ?></h4></div>
          <div>
            <input type="text" id="<?php echo $element['name']; ?>_url_0" size="50" value=""
                   class="upload image_links_group">

            <input type="button" class="<?php echo $element['name']; ?>_update-image slide_but_up"
                   id="<?php echo $element['name']; ?>_update-button_0"
                   value="<?php esc_attr_e("Update image", "business-elite"); ?>">

            <input type="button" class="<?php echo $element['name']; ?>_remove-image slide_but_rem wdwt_btn_red"
                   id="<?php echo $element['name']; ?>_remove-button_0"
                   value="<?php esc_attr_e("Remove this slide", "business-elite"); ?>"/>
          </div>
        </div>
        <!-- Image -->
        ...
        <div class="slide-from-base_title">
          ...
          <div><input type="text" id="<?php echo $element['name']; ?>_title_0" class="image_title_group" value=""/>
          </div>
        </div>
        <!-- Image DESCRIPTION -->
        <div class="slide-from-base_desc" style="margin-bottom:3%;">
          ...
          <div>
            <textarea class="image_descr_group" id="<?php echo $element['name']; ?>_descr_0"
                      style="width:236px; height:120px;"></textarea>
          </div>
        </div>
      </div>
      ...
      <div class="slider-controls">
        <div valign="middle">
          <h4>
            ...
            <span class="hasTip" style="cursor: pointer;color: #3B5998;"
                  title="<?php esc_attr_e("Add more than two images to the slider in PRO version.", "business-elite"); ?>">[?]</span>
          </h4>
        </div>
        <div>
          <input type="hidden" name="<?php echo $optionname_url; ?>" id="<?php echo $element['name']; ?>_urls"
                 data-customize-setting-link="<?php echo $optionname_url; ?>"
                 value="<?php echo esc_attr($imgs_url); ?>">
          <input type="hidden" name="<?php echo $optionname_href; ?>" id="<?php echo $element['name']; ?>_hrefs"
                 data-customize-setting-link="<?php echo $optionname_href; ?>"
                 value="<?php echo esc_attr($imgs_href); ?>">
          <input type="hidden" name="<?php echo $optionname_title; ?>" id="<?php echo $element['name']; ?>_titles"
                 data-customize-setting-link="<?php echo $optionname_title; ?>"
                 value="<?php echo esc_attr($imgs_title); ?>">
          <input type="hidden" name="<?php echo $optionname_desc; ?>" id="<?php echo $element['name']; ?>_descrs"
                 data-customize-setting-link="<?php echo $optionname_desc; ?>"
                 value="<?php echo esc_attr($imgs_desc); ?>">
          <input class="upload_button_slide" type="button" id="<?php echo $element['name']; ?>_add-button"
                 value="<?php esc_attr_e('Add new slide', "business-elite"); ?>"/>
        </div>
      </div>
    </div>
    <script type="text/javascript">
  ...
  public function select_theme($element, $context = 'option', $opt_val = '', $meta = array())
  {
    ...
    $width = isset($element["width"]) ? $element["width"] : $this->params["select_width"]; ?>
    <div class="wdwt_param" id="wdwt_wrap_<?php echo $element['name']; ?>">
      <select name="<?php echo $optionname; ?>[active]"
              id="<?php echo $element['name'] ?>" <?php $this->custom_attrs($element); ?>
              style="width:<?php echo $width; ?>px;">
        <?php for ($i = 0; $i < sizeof($element['default']['themes']); $i++) { ?>
          <option
            value="<?php echo $i ?>" <?php selected($current, $i); ?>> <?php echo esc_html($element['default']['themes'][$i]['title']); ?></option>
        <?php } ?>
      </select>
    </div>
    <script>/*stop here*/
      jQuery(document).ready(function ()
      {
        ...
        ?>
        element_<?php echo $element['name']; ?>.themes.push({
          name: "<?php echo $opt_val['themes'][$i]['name']; ?>",
          title: "<?php echo esc_attr($opt_val['themes'][$i]['title']); ?>"
        });
        var theme_colors = {};
        <?php
        ...
        ?>
        theme_colors["<?php echo $color_name; ?>"] = {
          name: "<?php echo $color_name; ?>",
          val: "<?php echo $color['value']; ?>",
          def: "<?php echo $color['default']; ?>"
        };
        <?php
        }
  ...
  public function colors($element, $context = 'option', $opt_val = '', $meta = array())
  {
    ...
    <div class="wdwt_param" id="wdwt_wrap_<?php echo $element['name']; ?>">
      <input type="text" class="hidden_field" id="theme_<?php echo $element['name']; ?>" hidden='hidden'
             name="<?php echo $optionname . '[select_theme]'; ?>"
             value="<?php echo esc_attr($opt_val['select_theme']); ?>">
      <input type="text" class="hidden_field" id="active_<?php echo $element['name']; ?>" hidden='hidden'
             name="<?php echo $optionname . '[active]'; ?>" value="<?php echo esc_attr($opt_val['active']); ?>">
      <?php foreach ($element['color_panel_defaults'][$opt_val['active']] as $color_name => $color):
        ...
        <div class='wdwt_float'>
          ...
          <div>
            <input type="text" class="hidden_field"
                   id="default_<?php echo $element['name']; ?>_<?php echo $color_name; ?>" hidden='hidden'
                   name="<?php echo $optionname . '[colors][' . $color_name . ']' . '[default]'; ?>"
                   value="<?php echo $color['default']; ?>">
            <input type="text" class='color_input' id="value_<?php echo $element['name']; ?>_<?php echo $color_name; ?>"
                   name="<?php echo $optionname . '[colors][' . $color_name . ']' . '[value]'; ?>"
                   value="<?php echo $color['value']; ?>" data-default-color="<?php echo $color['default']; ?>"
  ...
  public function diagram($element, $context = '', $opt_val = '', $meta = array())
  {
    ...
    <div class="wdwt_param" id="wdwt_wrap_<?php echo $element['name']; ?>">
      ...
      <div class="wdwt_diagram wdwt_diagram_<?php echo $element['name']; ?> last_percent"
           id="wdwt_diagram_<?php echo $element['name']; ?>_0">
        <!-- Percent TITLE -->
        <div class="diagram-from-base_title">
          <div valign="middle">
            <h4><?php esc_html_e("Title", "business-elite"); ?></h4>
          </div>
          <div><input type="text" id="<?php echo $element['name']; ?>_title_0" class="diagram_title_group" value=""/>
          </div>
        </div>
        <!-- percent DESCRIPTION -->
        <div class="diagram-from-base_desc" style="margin-bottom:3%;">
          ...
          <div>
            ...
            <input type="button" class="<?php echo $element['name']; ?>_remove-percent wdwt_btn_red"
                   id="<?php echo $element['name']; ?>_remove-button_0"
                   value="<?php esc_attr_e("Remove this percent", "business-elite"); ?>"/>
          </div>
        </div>
      </div>
      ...
      <div class="diagram-controls">
        <div>
          <input type="hidden" name="<?php echo $optionname_title; ?>" id="<?php echo $element['name']; ?>_titles"
                 data-customize-setting-link="<?php echo $optionname_title; ?>"
                 value="<?php echo esc_attr($diagram_title); ?>">
          <input type="hidden" name="<?php echo $optionname_percent; ?>" id="<?php echo $element['name']; ?>_percents"
                 data-customize-setting-link="<?php echo $optionname_percent; ?>"
                 value="<?php echo esc_attr($diagram_percent); ?>">
          <input class="add_percent wdwt_btn_blue" type="button" id="<?php echo $element['name']; ?>_add-button"
                 value="<?php esc_attr_e('Add new percent value', "business-elite"); ?>"/>
        </div>
      </div>
    </div>
    <script type="text/javascript">
