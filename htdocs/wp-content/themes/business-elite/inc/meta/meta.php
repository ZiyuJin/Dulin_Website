...
function wdwt_meta_init(){ 
	$wdwt_post_meta = new Business_elite_meta();  
}
require_once('WDWT_meta.php');

class Business_elite_meta extends WDWT_meta {
	public function __construct(){ 
		wp_enqueue_style( WDWT_VAR.'_admin_stylesheet', WDWT_URL . '/inc/css/admin.css', array(), WDWT_VERSION );  
		wp_enqueue_script(WDWT_VAR.'_admin_element_view_script', WDWT_URL.'/inc/lib/WDWT_elements.js',array( /*'jquery','wp-color-picker'*/ ), WDWT_VERSION);
		...
		$layout = new Business_elite_meta_layout_controller();
