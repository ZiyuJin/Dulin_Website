...
class WDWT_Lightbox {
  ...
  public function view() {
    ...
    <style>
      ...
      .wdwt_popup_image {
        max-width: <?php echo intval($image_width); ?>px;
        max-height: <?php echo intval($image_height); ?>px;
    ...
    <script>
      ...
      function wdwt_popup_resize() {
        ...
        if (jQuery(window).height() > <?php echo intval($image_height); ?> && <?php echo $open_with_fullscreen ? 1 : 0 ; ?> != 1 ) {

          jQuery("#wdwt_spider_popup_wrap").css({
            height: <?php echo intval($image_height); ?>,
            top: '50%',
            marginTop: -<?php echo intval($image_height) / 2; ?>,
            zIndex: 100000
          });
          jQuery(".wdwt_image_container").css({height: (<?php echo intval($image_height); ?>)});

          jQuery(".wdwt_popup_image").css({
            maxHeight: <?php echo intval($image_height) ; ?>
          });

          wdwt_popup_current_height = <?php echo intval($image_height); ?>;
        }
        else {
          jQuery("#wdwt_spider_popup_wrap").css({
        ...
        if (jQuery(window).width() >= <?php echo intval($image_width); ?> && <?php echo $open_with_fullscreen ? 1 : 0 ; ?> != 1 ) {
          jQuery("#wdwt_spider_popup_wrap").css({
            width: <?php echo intval($image_width); ?>,
            left: '50%',
            marginLeft: -<?php echo intval($image_width) / 2; ?>,
            zIndex: 100000
          });
          jQuery(".wdwt_image_wrap").css({width: <?php echo intval($image_width); ?>});
          jQuery(".wdwt_image_container").css({width: (<?php echo intval($image_width); ?>)});

          jQuery(".wdwt_popup_image").css({maxWidth: <?php echo intval($image_width); ?>});

          wdwt_popup_current_width = <?php echo intval($image_width); ?>;
        }
        else {
          jQuery("#wdwt_spider_popup_wrap").css({
        ...
        if (((jQuery(window).height() > <?php echo intval($image_height) - 2 * $theme_row['lightbox_close_btn_top']; ?>) && (jQuery(window).width() >= <?php echo intval($image_width) - 2 * $theme_row['lightbox_close_btn_right']; ?>)) && (<?php echo $open_with_fullscreen ? 1 : 0 ; ?> != 1)) {
      ...
      var wdwt_popup_current_width = <?php echo intval($image_width); ?>;
      var wdwt_popup_current_height = <?php echo intval($image_height); ?>;
      ...
      jQuery(document).ready(function () {
        ...
        jQuery(".wdwt_resize-full").on(wdwt_click, function () {
          ...
          if (jQuery(".wdwt_resize-full").hasClass("fa-compress")) {
            if (jQuery(window).width() > <?php echo intval($image_width); ?>) {
              wdwt_popup_current_width = <?php echo intval($image_width); ?>;
            }
            if (jQuery(window).height() > <?php echo intval($image_height); ?>) {
              wdwt_popup_current_height = <?php echo intval($image_height); ?>;
            }
            // Minimize.
