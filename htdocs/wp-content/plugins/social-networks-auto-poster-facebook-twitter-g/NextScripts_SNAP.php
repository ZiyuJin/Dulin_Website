...
*/
define( 'NextScripts_SNAP_Version' , '4.0.11' ); define( 'NextScripts_SNAP_Version_Date' , 'Nov 10, 2017' ); require_once "inc/nxs_functions_wp.php"; if(!defined( 'NXSSNAP_BASENAME' ) ) define( 'NXSSNAP_BASENAME', plugin_basename( __FILE__ ) );
