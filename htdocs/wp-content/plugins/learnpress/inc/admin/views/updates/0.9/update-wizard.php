...
<div class="lp-update-content">
	<form name="learn-press-upgrade" method="post" action="options-general.php?page=learn_press_upgrade_from_09&_wpnonce=<?php echo wp_create_nonce( 'learn-press-upgrade-09' ); ?>">
