...
$wpdb->comments.*, user_nicename FROM ".$wpdb->comments." LEFT JOIN ".$wpdb->users." ON ".$wpdb->comments.".comment_ID = user_id WHERE comment_post_ID = ".get_the_ID()." ORDER BY comment_ID DESC LIMIT 1");
// to you / other
//var_dump($status);
?>
